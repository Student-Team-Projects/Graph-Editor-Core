...
public class PropertySupportingGraph implements Graph, PropertyRepository, Serializable {
    private static final long serialVersionUID = 2L;
    private Graph properGraph;
    private Map<String, GraphProperty> properties;

    PropertySupportingGraph(Graph properGraph, Map<String, GraphProperty> properties) {
